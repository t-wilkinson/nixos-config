...
in
{
  ...
  #     '';
  #     # ExecStop = ''
  #     #   -${pkgs.iproute2}/bin/ip route del ${homelab.homelabIP}/32 via ${homelabDirectGateway} dev enp4s0
  #     #   -${pkgs.iproute2}/bin/ip route del ${homelab.containerNetwork}.0/24 via ${homelabDirectGateway} dev enp4s0
  #     # '';
  #   };
  # };
