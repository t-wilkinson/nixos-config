...
hi MatchParen guifg=#{{ $secondary }} guibg=#{{ $onSecondary }} gui=NONE cterm=NONE
hi SignColumn guifg=#{{ $onSurfaceVariant }} guibg=#{{ $surface }} gui=NONE cterm=NONE
hi Pmenu guifg=#{{ $outline }} guibg=#{{ $inverseOnSurface }} gui=NONE cterm=NONE
hi PmenuSbar guifg=NONE guibg=#{{ $inverseSurface }} gui=NONE cterm=NONE
hi PmenuSel guifg=#{{ $onPrimary }} guibg=#{{ $tertiary }} gui=NONE cterm=NONE
hi PmenuThumb guifg=#{{ $tertiary }} guibg=#{{ $tertiary }} gui=NONE cterm=NONE
hi ErrorMsg guifg=#{{ $error }} guibg=#{{ $onPrimary }} gui=reverse cterm=reverse
hi ModeMsg guifg=#{{ $tertiary }} guibg=#{{ $onPrimary }} gui=reverse cterm=reverse
hi MoreMsg guifg=#{{ $tertiary }} guibg=NONE gui=NONE cterm=NONE
hi Question guifg=#{{ $tertiary }} guibg=NONE gui=NONE cterm=NONE
hi WarningMsg guifg=#{{ $error }} guibg=NONE gui=NONE cterm=NONE
hi TabLine guifg=#{{ $secondaryContainer }} guibg=#{{ $inverseOnSurface }} gui=NONE cterm=NONE
hi TabLineFill guifg=#{{ $inverseOnSurface }} guibg=#{{ $inverseOnSurface }} gui=NONE cterm=NONE
hi TabLineSel guifg=#{{ $onPrimary }} guibg=#{{ $secondaryContainer }} gui=NONE cterm=NONE
hi ToolbarLine guifg=NONE guibg=#{{ $inverseOnSurface }}  gui=NONE cterm=NONE
hi ToolbarButton guifg=#{{ $outline }} guibg=#{{ $inverseSurface }} gui=NONE cterm=NONE
hi Cursor guifg=#{{ $onPrimary }} guibg=#{{ $outline }} gui=NONE cterm=NONE
hi CursorColumn guifg=NONE guibg=#{{ $onSurfaceVariant }} gui=NONE cterm=NONE
hi StatusLine guifg=#{{ $onPrimary }} guibg=#{{ $secondaryContainer }} gui=NONE cterm=NONE
hi StatusLineNC guifg=#{{ $secondaryContainer }} guibg=#{{ $inverseOnSurface }} gui=NONE cterm=NONE
hi StatusLineTerm guifg=#{{ $onPrimary }} guibg=#{{ $secondaryContainer }} gui=NONE cterm=NONE
hi StatusLineTermNC guifg=#{{ $secondaryContainer }} guibg=#{{ $inverseOnSurface }} gui=NONE cterm=NONE
hi Visual guifg=#{{ $primary }} guibg=#{{ $onPrimary }} gui=reverse cterm=reverse
hi VisualNOS guifg=NONE guibg=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
hi VertSplit guifg=#{{ $inverseOnSurface }} guibg=#{{ $inverseOnSurface }} gui=NONE cterm=NONE
hi WildMenu guifg=#{{ $onPrimary }} guibg=#{{ $primary }} gui=NONE cterm=NONE
hi DiffAdd guifg=#{{ $surface }} guibg=#{{ $onSurfaceVariant }} gui=reverse cterm=reverse
hi DiffChange guifg=#{{ $surfaceVariant }} guibg=#{{ $onSurfaceVariant }} gui=reverse cterm=reverse
hi DiffDelete guifg=#{{ $error }} guibg=#{{ $onError }} gui=reverse cterm=reverse
hi DiffText guifg=#{{ $inverseSurface }} guibg=#{{ $onSurfaceVariant }} gui=reverse cterm=reverse
hi IncSearch guifg=#{{ $onPrimary }} guibg=#{{ $error }} gui=NONE cterm=NONE
hi Search guifg=#{{ $onPrimary }} guibg=#{{ $tertiaryContainer }} gui=NONE cterm=NONE
hi Directory guifg=#{{ $tertiary }} guibg=NONE gui=NONE cterm=NONE
hi debugPC guifg=NONE guibg=#{{ $secondary }} gui=NONE cterm=NONE
hi debugBreakpoint guifg=NONE guibg=#{{ $error }} gui=NONE cterm=NONE
hi SpellBad guifg=#{{ $error }} guibg=NONE guisp=#{{ $error }} gui=undercurl cterm=undercurl
...
hi PreProc guifg=#{{ $tertiary }} guibg=NONE gui=NONE cterm=NONE
hi Special guifg=#{{ $secondary }} guibg=NONE gui=NONE cterm=NONE
hi Statement guifg=#{{ $primary }} guibg=NONE gui=NONE cterm=NONE
hi String guifg=#{{ $tertiary }} guibg=NONE gui=NONE cterm=NONE
hi Todo guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
hi Type guifg=#{{ $secondary }} guibg=NONE gui=NONE cterm=NONE
hi Underlined guifg=#{{ $tertiary }} guibg=NONE gui=underline cterm=underline
hi Function guifg=#{{ $tertiaryContainer }} guibg=NONE gui=NONE cterm=NONE
hi SpecialKey guifg=#{{ $outline }} guibg=NONE gui=NONE cterm=NONE
